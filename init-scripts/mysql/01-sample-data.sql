-- Sample data for testing DataProfiler (MySQL)
-- This script runs automatically when MySQL container starts

-- Create databases (MySQL's equivalent of Schemas)
CREATE DATABASE IF NOT EXISTS prod;
CREATE DATABASE IF NOT EXISTS uat;

GRANT ALL PRIVILEGES ON prod.* TO 'user'@'%';
GRANT ALL PRIVILEGES ON uat.* TO 'user'@'%';
...
-- Insert sample data into PROD (99 records)
...
-- Insert sample data (111 records)
...
-- Insert sample data into UAT (80 records)
INSERT INTO users (username, email, age, salary, is_active, middle_name) VALUES
...
-- Insert sample data (90 records)
INSERT INTO products (name, category, price, stock_quantity, is_available, sku, discount_percent) VALUES
