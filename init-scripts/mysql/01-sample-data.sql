...
-- public usually doesn't exist in MySQL, using explicit DB for it
CREATE DATABASE IF NOT EXISTS public;

GRANT ALL PRIVILEGES ON prod.* TO 'user'@'%';
GRANT ALL PRIVILEGES ON uat.* TO 'user'@'%';
GRANT ALL PRIVILEGES ON public.* TO 'user'@'%';
...
-- Replicate products table from prod
CREATE TABLE IF NOT EXISTS products LIKE prod.products;
INSERT INTO products SELECT * FROM prod.products;

-- Insert sample data into UAT (Explicitly)
INSERT INTO users (username, email, age, salary, is_active) VALUES
    ('john_doe', 'john@example.com', 28, 55000.00, true),
    ('jane_smith', 'jane@example.com', 34, 72000.00, true),
    ('bob_wilson', 'bob@example.com', 45, 85000.00, true),
