...
| Metric                | คำอธิบาย                                |
| --------------------- | --------------------------------------- |
| `row_count`           | จำนวนแถวทั้งหมดในตาราง                  |
| `not_null_proportion` | สัดส่วนค่าที่ไม่เป็น NULL (0.00 - 1.00) |
| `distinct_proportion` | สัดส่วนค่าที่ไม่ซ้ำกัน (0.00 - 1.00)    |
| `distinct_count`      | จำนวนค่าที่ไม่ซ้ำกัน                    |
| `is_unique`           | เป็น unique หรือไม่ (true/false)        |
| `min` / `max`         | ค่าต่ำสุด / สูงสุด                      |
| `avg`                 | ค่าเฉลี่ย (เฉพาะ numeric)               |
| `median`              | ค่ามัธยฐาน (เฉพาะ numeric)              |
| `std_dev_population`  | Standard deviation (population)         |
| `std_dev_sample`      | Standard deviation (sample)             |
